...
private:
	...
	size_t Size; // error! óáðàòü, çàìåíèòü íà cur
...
public:
	...
	void set(Newspaper* data, size_t index) { // set íà edit                   *исправить для пользователя просмотреть ввод индекса во внешней функции
		size_t size = GetSize();
